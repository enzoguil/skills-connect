...
const Navbar = () => {
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light border-bottom border-gray" style={{ background: "#f8f9fa" }}>
            <div className="container d-flex align-items-center justify-content-between" style={{ minHeight: 80 }}>
                <a className="navbar-brand"><img src={logoPrincipal} style={{ width: "150px" }} alt="logo" /></a>
                ...
                <span className="ms-3">
                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1332 1176" width="50" height="50">
